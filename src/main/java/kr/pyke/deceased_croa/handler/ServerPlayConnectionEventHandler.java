...
import kr.pyke.deceased_croa.network.pakcet.s2c.S2C_SyncBulkTeleportEntriesPacket;
...
public class ServerPlayConnectionEventHandler {
    ...
    public static void register() {
        ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
            ...
            S2C_SyncBulkTeleportEntriesPacket.send(serverPlayer, TeleportData.getServerState(server).getEntries());
        });
    }
}
